...
public enum HKRatingImage: String {
    ...
    case flag = "SF_flag"
    case bell = "SF_bell"
    // These are images stored in the bundle. There must be one with the corresponding name along with one with the .fill suffix.  All images should be stored as a Template images, rendered as Single Scale.
    case baseball
    case basketball
    case football
    case custom
